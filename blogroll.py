...
def getGiteeFriends(user, repo):
    ...
    """
    gitee_repo = "https://gitee.com/api/v5/repos/" + user + "/" + repo + "/issues?state=closed&sort=created&direction=asc&page=1&per_page=100"
...
def downloadFriends(url_prefix="https://image.thum.io/get/width/400/crop/800/allowJPG/wait/20/noanimate/https://",
    ...
    os.system("mkdir jpg")
    for link in links:
        os.system("curl " + url_prefix + link + url_suffix +" -o ./jpg/" + link + "." + suffix)
